...
- **Season window.** Widened from the plan's Sept 1 default to Aug 1 (see
  ...
  be changed.
- **Cross-site context.** This is the strongest of the four sites run this phase (most
  usable years, cleanest season-window coverage). See `../outputs_by_site/SUMMARY.md`
  for the Nanaimo, Cowichan, and Little Qualicum comparisons -- the same headline
  result (day-of-year outperforms the environmental features) holds at 3 of 4 sites.